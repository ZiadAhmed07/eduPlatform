        ...
        <div className=" w-full h-auto min-h-screen  flex items-center justify-center">
            ...
            <div className="bg-gray-50 max-sm:bg-gray-200/80 max-sm:w-full max-sm: dark:bg-gray-700 max-sm:dark:bg-gray-700/80 shadow-xl rounded-lg overflow-hidden">
                <div className="grid grid-cols-2">
                    <Link href={'/auth/parent'} className="bg-gray-200 dark:bg-gray-800 px-6 py-2 shadow-inner text-center" >دخول</Link>
                    <Link href={'/auth/parent/signup'} className="font-bold px-6 py-2 text-center " >حساب جديد</Link>
                </div>
                <div className=" p-6 flex flex-col items-center">
                    ...
                    <form className="w-[600px] grid grid-cols-2 gap-4 py-6 max-sm:flex flex-col max-sm:w-full">
                        ...
                        <div>
                            ...
                            <input type="number" required name="phoNum" onChange={handleChange} className=" w-full h-10 border-2 focus:border-[3px] outline-none border-sky-300 rounded-md px-2 bg-inherit" />
                        </div>
                        <div>
                            <label>id الطالب</label><br />
                            <input type="number" required name="student_id" onChange={handleChange} className=" w-full h-10 border-2 focus:border-[3px] outline-none border-sky-300 rounded-md px-2 bg-inherit" />
                        </div>
