...
export default function page(){
    ...
    return(
        <div className=" w-full h-auto min-h-screen  flex items-center justify-center">
            <BackGround/>
            <div className="bg-gray-50  max-sm:h-screen sm:-translate-y-[80px] flex flex-col justify-between max-sm:bg-gray-200/80 max-sm:w-full max-sm:dark:bg-gray-700 max-sm:dark:bg-gray-700/80 shadow-xl rounded-lg overflow-hidden">
                <div className="grid grid-cols-2 ">
                    <Link href={'/auth/student'} className="font-bold px-6 py-2 text-center " >دخول</Link>
                    <Link href={'/auth/student/signup'} className="bg-gray-200 dark:bg-gray-800 px-6 py-2 shadow-inner text-center"   >حساب جديد</Link>
                </div>
