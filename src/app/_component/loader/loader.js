...
export default function Loader() {
    return (
        <div className="w-full h-screen flex items-center justify-center bg-gray-300/80 fixed top-0 z-50 flex-col gap-6">
            <div>
            ...
            <p className="text-emerald-500 font-bold text-[25px]">جارى التحميل...</p>
        </div>
    )
}